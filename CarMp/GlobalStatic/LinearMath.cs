...
namespace CarMP
{
    public static class LinearMath
    {
        ...
        public static float DistanceBetweenTwoPoint(Point pPoint1, Point pPoint2)
        {
        ...
        public static float SlopeOfTwoPoints(Point pPoint1, Point pPoint2)
        {
            float slope = 1;
        ...
        /// </summary>
        public static float AngleOfTwoPoints(Point pPoint1, Point pPoint2)
        {
            float angle;
